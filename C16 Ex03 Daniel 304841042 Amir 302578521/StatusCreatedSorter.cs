...
{
    public class StatusCreatedSorter : StatusSorter
    {
        public StatusCreatedSorter(ListBox i_ListBox)
            : base(i_ListBox)
        {
        }

        public StatusCreatedSorter()
        {      
        }
        ...
        public override void Sort()
        {
            ...
            statuses = statuses.OrderBy(o => o.CreatedTime).ToList();
